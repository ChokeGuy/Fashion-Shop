  ...
  const handleNewImageFiles = useCallback(
    (files: File[], insertPosition?: number): void => {
      ...
      insertImages({
        ...
        position: insertPosition, // Add the 'position' property here
      });
    },
    []
  );
    ...
    <>
          ...
          RichTextFieldProps={{
            ...
            footer: (
              ...
              >
                <MenuButton
                  value="formatting"
                  tooltipLabel={showMenuBar ? "Ẩn format" : "Hiện format"}
                  size="small"
                  onClick={() =>
      ...
      {submittedContent ? (
        <>
          ...
          <Box padding={2}>
            <Typography variant="subtitle1">Snapshot của mô tả:</Typography>
